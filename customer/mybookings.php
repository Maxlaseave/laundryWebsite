...
<?php
    ...
    $sql1 = "SELECT * FROM selfService WHERE status IN('Pending', 'In Progress', 'Confirmed') AND userId = $userID";
    $result1 = mysqli_query($conn, $sql1);

    $sql2 = "SELECT * FROM dropoff  WHERE status IN('Pending', 'In Progress', 'Confirmed') AND userId = $userID";
